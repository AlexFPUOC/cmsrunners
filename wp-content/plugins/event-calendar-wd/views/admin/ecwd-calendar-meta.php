        ...
        <tr>
            ...
            <span class="ecwd-calendar-event-add">
                    <?php if ($excluded_events) { ?>
                        <a class="ecwd_events_popup_button"><?php _e('Select Events from the list', 'event-calendar-wd'); ?></a>
                        <a class="ecwd_events_popup_button"><span class="add_event_plus">+</span></a></span>
                <?php } else { ?>
                    <a href="<?php echo get_admin_url() ?>post-new.php?post_type=ecwd_event&cal_id=<?php echo $post_id; ?>" target="_blank"><?php _e('Add Event', 'event-calendar-wd'); ?></a>
